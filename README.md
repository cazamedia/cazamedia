...
+ When issuing DML queries to SQL databases, it is often desirable to keep a history of changes for auditing and/or logging purposes.  This is typically done using *trigger* functions.
