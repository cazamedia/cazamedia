...
+ TIP: SQLite's *EXPLAIN QUERY PLAN* is extremely helpful in determining how the SQLite query planner is going to execute a query.  Use it to help tweak your SQL queries for optimal performance.
